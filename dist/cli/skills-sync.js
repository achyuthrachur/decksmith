...
import { skillsManifest } from '../data/skills-manifest.js';
const REPO_OWNER = 'achyuthrachur';
const REPO_NAME = 'decksmith';
const CLAUDE_DEFAULT_DEST = path.join('C:\\Users\\RachurA\\AI Coding Projects\\.claude\\skills');
const CODEX_DEFAULT_DEST = path.join(process.env['CODEX_HOME'] ?? path.join(process.env['USERPROFILE'] ?? '~', '.codex'), 'skills');
...
function rawUrl(ref, skillName, filePath) {
