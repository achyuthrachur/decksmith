...
export const generateAssetDocsSchema = z.object({
  interviewAnswers: z.string().describe(
    'Full text of the interview answers from all 5 blocks (A–E). ' +
...
export async function runGenerateAssetDocs(input: GenerateAssetDocsInput): Promise<string> {
